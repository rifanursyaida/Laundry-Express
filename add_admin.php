                              ...
                              <div class="box-body">
                                ...
                                <div class="row">
                                  <div class="form-group col-md-12 col-xs-12">
                                    ...
                                    <div class="col-sm-9">
                                      <a href="validasi_cek.php" class="btn btn-primary btn-sm" name="cari" id="cekbutton">Cek</a>
                                      <br>
                                      <?php if ($no != null || $no != "") { ?>
                                        <input type="text" class="form-control" id="username" onekeyup="username()" name="username" value="<?php echo $username; ?>" maxlength="20" required readonly>
                                      <?php } else { ?>
                                        <input type="text" class="form-control" id="username" onekeyup="username()" name="username" value="<?php echo $username; ?>" placeholder="Masukan Username" maxlength="20" required>
                                      <?php } ?>
                                    </div>
                                  </div>
                                </div>
...
<script>
  $('#username').keyup(function() {
    $('#cekbutton').attr('href', 'validasi_cek.php?userna_me=' + $(this).val())
  })
