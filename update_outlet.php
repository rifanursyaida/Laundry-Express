        ...
        <section class="content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $halaman = "outlet"; // data
                    $dataapa = "outlet"; // data apa
                    $tabeldatabase = "outlet"; // tabel database
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div id="main">
                                        <div class="container-fluid">
                                            ...
                                            <form class="form-horizontal" method="post" action="proses_outlet.php" id="Myform">
                                                <div class="box-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6 col-xs-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" id="no" name="no" value="<?php echo $no; ?>" placeholder="Auto Number" maxlength="50">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6 col-xs-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Outlet" maxlength="50" value="<?php $nama ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group col-md-6 col-xs-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $nama; ?>" placeholder="Masukan Alamat Outlet" maxlength="50" value="<?php $alamat ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group col-md-6 col-xs-12">
                                                            <label for="nama" class="col-sm-3 control-label">Nomor Telp:</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" id="telp" name="telp" value="<?php echo $nama; ?>" placeholder="Masukan Telepon Outlet" maxlength="50" value="<?php $telp ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin') {
                                                    $sql1 = "update $tabeldatabase set nama='$nama' alamat='$alamat' telp='$telp' where no='$no'";
                                                ...
                                                $sql2 = "insert into $tabeldatabase values( '$no','$nama','$alamat','$telp')";
